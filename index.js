...
const getPrimeNumbers = require('./js/sequences-other/prime-numbers/get-prime-numbers')
const getNPrimeNumbers = require('./js/sequences-other/prime-numbers/get-n-prime-numbers')
const getNthPrimeNumber = require('./js/sequences-other/prime-numbers/get-nth-prime-number')
const isPrimeNumber = require('./js/sequences-other/prime-numbers/is-prime-number')
const isPrimeNumberFast = require('./js/sequences-other/prime-numbers/is-prime-number-fast')
